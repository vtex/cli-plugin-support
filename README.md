...
@vtex/cli-plugin-support/0.0.2-beta.0 linux-x64 node-v12.20.1
$ vtex --help [COMMAND]
USAGE
  $ vtex COMMAND
...
...
_See code: [build/commands/support.ts](https://github.com/vtex/cli-plugin-support/blob/v0.0.2-beta.0/build/commands/support.ts)_
<!-- commandsstop -->
